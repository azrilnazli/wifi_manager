...
<?php echo $this->Form->create('Radacct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Radacct'); ?></legend>
	<?php
		echo $this->Form->input('radacctid');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Radacct.radacctid')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Radacct.radacctid')))); ?></li>
